    ...
    >
      ...
      <div className="flex-1 flex flex-col">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Connect with our team of experienced immigration consultants and get expert guidance for
          visas, residency, and citizenship applications. Let us help make your move abroad smooth
          and successful.
        </p>
      </div>
